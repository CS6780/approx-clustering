...
\item[$P$-median]
\item[UCI Iris Dataset] This is one of the most used data sets in pattern recognition (\cite{Iris}).  It contains data on 150 instances of flowers, each of with belongs to one of three species of iris.  One of the species is linearly seperable from the others, but the other two are not.  In total, there are 150 instances and 4 attributes.
